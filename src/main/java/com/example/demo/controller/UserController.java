...
public class UserController {
	...
	public Map<String,String> addUser(@Valid @RequestBody UserReq userReq){
		...
		person.age=100;
		person.descyqq="测试"+System.currentTimeMillis();
		person.name="哈哈";
	...
	public Map<String,Object> addRedis(@PathVariable("key") String key,@PathVariable("value") String value){
	...
	@GetMapping("/get1/{key}")
	public Map<String,Object> getRedis(@PathVariable("key") String key){

	String result=	redisTemplate.opsForValue().get(key);
		rabbitmqTemplate.convertAndSend("test","我获取到缓存数据了=="+result);
		Map<String,Object> result2 = new HashMap<String,Object>();
		log.info("====getRedis====="+result2);
		result2.put("key", key);
